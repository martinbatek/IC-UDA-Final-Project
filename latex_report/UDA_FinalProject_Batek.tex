...
%% Problem Statement
%% Outline approach. Link to course material
%% Link to Github Repo
\blindtext

\section{Literary Review}
%% Summarize key points from reference material
\blindtext
...
\subsection{Description and Justification of Analysis Methods}
\blindtext

\subsection{Interpolation and Reflection of Results}
\blindtext
