...
However multiple sources cite an increasing rate of occurence and degree of severity of global wildfires, past the point of biological sustainability \cite{Lasslop_2017,boegelsack2018critical,jones2020climate}. This phenomenan is widely attributed
to human intervention such as urbanization, agricultural practices and human made climate change.
...
\begin{figure}[h]
    ...
    \label{fig:FLAME_dataset_structure}
\end{figure}

Figure \ref{fig:FLAME_dataset_structure} shows that the dataset contains 47992 images, 8617 (18\%) of which are in
...
\begin{figure}[h]
    ...
    \label{fig:pixel_dims_values}
\end{figure}

It is shown in Figure \ref{fig:pixel_dims_values} above that all of the images in the dataset have been rescaled to 254x254 pixels (left), whereas the pixel
...
\begin{figure}[h]
    ...
    \label{fig:FLAME_examples}
\end{figure}

The images in Figure \ref{fig:FLAME_examples} appear as expected given that they were taken in Arizona in the winter month of January.
